...
- Long-term memory: {{ workspace_path }}/persona/memory/MEMORY.md (automatically managed by Dream — do not edit directly)
- History log: {{ workspace_path }}/persona/memory/history.jsonl (append-only JSONL; prefer built-in `grep` for search).
